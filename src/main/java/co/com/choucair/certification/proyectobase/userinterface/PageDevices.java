...
public class PageDevices {
    ...
    public static final Target CONTAINERCOMPUTER = Target.the("Container Computer")
    ...
    public static final Target CONTAINERVERSION = Target.the("Container Version")
    ...
    public static final Target CONTAINERLANGUAGE = Target.the("Container Language")
    ...
    public static final Target CONTAINERMOBILE = Target.the("Container Mobile")
